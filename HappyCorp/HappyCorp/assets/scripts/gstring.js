    ...
    $.fn.customize = function (options) {
        ...
        this.each(function () {
            ...
            self.customizeSelectDropdowns = function () {
                ...
                selectdropdowns.each(function () {
                    ...
                    if (!selectDropdown.closest("." + opts.class_fakeSelect).length) {
                        ...
                        $('body').append($(document.createElement('span')).addClass(opts.class_fakeSelect + '-options-container' + ' ' + idOriginalSelect).append('<ul />'));

                        var optionsContainer = $("." + opts.class_fakeSelect + '-options-container:last');
            ...
            self.bindSelectEvents = function (selectDropdown) {
                ...
                $(window).resize(function () {
                    self.setDropdownCSS(selectDropdown);
                });
            ...
            self.setDropdownCSS = function (selectDropdown) {
                var optionsCSS = {
                    'width': selectDropdown.selectWrapper.outerWidth()
                };
                selectDropdown.optionsContainer.css(optionsCSS);
            ...
            self.hideDropdown = function () {
                var optionsContainer = $("." + opts.class_fakeSelect + '-options-container');
                switch (opts.displayDropdownEffect) {
